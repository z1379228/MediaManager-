...
目前來源版本為開發版 6.0，核心與網站功能分離。GitHub 的 `v4.0.0` 是已公開、
不可覆寫的未簽署 `SAFE_MODE` 工程基線；目前 main 含發行後維護修正，下一次
重建必須使用新版本，不能以相同 4.0.0 重新定義舊附件。4.1～4.5 僅提供更新
簡介，不另外發布重複的大型安裝檔：
...
3.0 完成紀錄位於 [`docs/release-3.0.md`](docs/release-3.0.md)；3.1～4.0 的
舊提案已封存於 [`docs/roadmap-3.1-to-4.0.md`](docs/roadmap-3.1-to-4.0.md)，
不可再作為目前完成度依據。

3.1～3.5 已完成項目的精簡說明位於
[`docs/release-3.1-to-3.5-summary.md`](docs/release-3.1-to-3.5-summary.md)。

4.0 實際完成與限制見 [`docs/release-4.0.md`](docs/release-4.0.md)；4.0～5.0
唯一版本排序與取捨依據為
[`docs/roadmap-4.0-to-5.0.md`](docs/roadmap-4.0-to-5.0.md)，5.0 的正式放行條件
與 Preview 實際完成內容分別見 [`docs/roadmap-5.0.md`](docs/roadmap-5.0.md) 及
[`docs/release-5.0.md`](docs/release-5.0.md)。
