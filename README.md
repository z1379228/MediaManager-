...
目前來源版本為開發版 10.3，核心與網站功能分離。GitHub 的 `v6.0.0` 是已公開的
...
- 預設關閉的 MEGA 公開檔案下載 MOD；啟用後才顯示獨立工作區，使用本機安裝的官方
  `mega-get` 分流下載。10.1 可辨識資料夾分享，並在取得實際檔名後區分影片、壓縮檔、文檔、音訊與圖片；目前只下載單一公開檔案
