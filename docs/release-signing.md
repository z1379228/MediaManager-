...
Development 39.0.8 retains the tested split-phase Stable operator and compiled
the production Ed25519 public identity. The private key remains outside the
repository. Development 39.0.8 is source-frozen. The old single-command Stable
