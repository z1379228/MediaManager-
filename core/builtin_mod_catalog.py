...
BUILTIN_MOD_CATALOG = (
    ...
    BuiltinModDescriptor(
        ...
        "啟用後顯示 Threads 官方工具工作區", True, "threads",
    ),
    BuiltinModDescriptor(
        "twitter", "X / Twitter", "feature", "官方貼文頁與帳號資料匯出入口",
        "啟用後顯示 X 官方工具工作區", True, "twitter",
    ),
    BuiltinModDescriptor(
    ...
    BuiltinModDescriptor(
        ...
        "Instagram 官方工具工作區", True, parent_provider_id="instagram",
    ),
    BuiltinModDescriptor(
    ...
    BuiltinModDescriptor(
        ...
        "Threads 官方工具工作區", True, parent_provider_id="threads",
    ),
    BuiltinModDescriptor(
    ...
    BuiltinModDescriptor(
        ...
        "X 官方工具工作區", True, parent_provider_id="twitter",
    ),
    BuiltinModDescriptor(
    ...
    BuiltinModDescriptor(
        "media-convert", "格式工廠", "feature", "本機影音、音訊與靜態影像轉檔、壓縮、串接、切割與字幕處理",
        "啟用後顯示格式工廠工作區", True, "media-convert",
        dependency_ids=("ffmpeg",),
    ),
    BuiltinModDescriptor(
    ...
    BuiltinModDescriptor(
        ...
        optional_dependency_ids=("whisper-cli", "speech-model"),
    ),
    BuiltinModDescriptor(
        "gopeed-transfer", "Gopeed Bridge", "feature",
        "連線至使用者自行啟動的 localhost Gopeed REST API，建立與管理傳輸工作",
        "啟用後顯示 Gopeed / P2P 工作區；不自動啟動或設定 Gopeed", True,
        "gopeed-transfer",
    ),
    BuiltinModDescriptor(
        "p2p-transfer", "P2P Transfer", "feature",
        "以明確合法使用與上傳確認，將 magnet 或 ed2k 工作交給本機 Gopeed",
        "Gopeed / P2P 工作區", True,
        parent_provider_id="gopeed-transfer",
    ),
    BuiltinModDescriptor(
