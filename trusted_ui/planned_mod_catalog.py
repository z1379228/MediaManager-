...
PLANNED_MODS = (
    ...
    PlannedMod(
        ...
        "P1",
        "Facebook 網址下載 MOD（無搜尋）",
        "只接受使用者貼上的公開 watch、reel 或影片頁網址；不讀 Cookie 或私人內容",
        "canonical URL、重新導向出站、登入／私人頁拒絕與公開影片 smoke",
    ),
    PlannedMod(
        "mega",
        "MEGA Download",
        "P1",
        "網站下載 MOD",
        "以官方 MEGA SDK／MEGAcmd 處理公開分享，沿用佇列、暫停、重試與通知",
        "官方工具適配、link key 去識別、配額錯誤與公開連結下載 smoke",
    ),
    PlannedMod(
        "self-check",
        "Self Check",
        "P2",
        "可信診斷模組（非外部 provider）",
        "手動檢查按鍵、分頁、registry、依賴與安全狀態；使用快取且不重跑完整流程",
        "唯讀診斷契約、remediation_id、無網路／無程序／無暫存保證與 JSON 匯出",
    ),
    PlannedMod(
        "direct-transfer",
        "Direct Transfer",
